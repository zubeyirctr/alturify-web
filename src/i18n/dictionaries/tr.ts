...
export const tr: Dictionary = {
  ...
  appointment: {
    ...
    subtitle: 'Bir tarih ve uygun bir saat dilimi seçin.',
    selectDatePrompt: 'Tarih seçin',
    selectTimePrompt: 'Uygun saatler',
    noSlotsMessage: 'Bu tarihte uygun saat yok — lütfen başka bir gün seçin.',
